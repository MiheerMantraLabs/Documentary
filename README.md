...
First Go To [Pusher](https://pusher.com/) and register your account & register your project there, and go to `dashboard/Get Started` & check for the function to server code using PHP. <img src="https://ourimagehosting.com/images/2022/10/03/image.png" hieght="50px" alt="php-select">
